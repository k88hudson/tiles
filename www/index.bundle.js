...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = __webpack_require__(177);
	...
	var Main = React.createClass({ displayName: "Main",
	  ...
	  togglePin: function togglePin(index) {
	  ...
	  removeItem: function removeItem(index) {
	    ...
	    items[index] = null;
	    var unpinned = items.filter(function (item) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", { className: "container" }, React.createElement(Search, null), React.createElement("div", { ref: "tiles", className: "tile-container" }, this.state.items.map(function (item, i) {
	      return React.createElement(Tile, React.__spread({ key: i, id: i }, item, { togglePin: _this.togglePin, removeItem: _this.removeItem }));
	    })));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  render: function render() {
	    ...
	    return React.createElement("div", { className: 'tile' + (this.props.pinned ? ' pinned' : '') }, React.createElement("div", { className: "tile-thumbnail" }), React.createElement("div", { className: "tile-title" }, this.props.title), React.createElement("img", { hidden: !this.props.pinned, className: "pinned-icon", alt: "tile is pinned", src: "./img/pin.svg" }), React.createElement("button", { onClick: function onClick() {
	        return _this.props.togglePin(_this.props.id);
	      }, className: "btn pin-btn" }, React.createElement("img", { alt: "pin", src: "./img/pin.svg" })), React.createElement("button", { onClick: function onClick() {
	        return _this.props.removeItem(_this.props.id);
	      }, className: "btn close-btn" }, React.createElement("img", { alt: "close", src: "./img/x.svg" })));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  render: function render() {
	    return React.createElement("form", { className: "search" }, React.createElement("div", { className: "search-input-wrapper" }, React.createElement("button", { className: "search-settings" }, React.createElement("img", { src: "./img/magnifier.png", alt: "change search settings" })), React.createElement("input", { className: "search-input" }), React.createElement("button", { className: "search-submit" }, "Search")));
	  }
	});
...
/***/ function(module, exports) {
	...
	var mockData = [{ title: 'New York Times' }, { title: 'Reddit' }, { title: 'Webmaker' }, { title: 'Toronto Star' }, { title: 'Twitter' }, { title: 'Facebook' }, { title: 'Foo' }, { title: 'Bar' }, { title: 'Baz' }, { title: 'Qux' }, { title: 'Flip' }, { title: 'Quack' }];
